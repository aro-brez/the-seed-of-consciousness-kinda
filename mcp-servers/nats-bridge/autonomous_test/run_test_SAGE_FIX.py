...
RESULTS_DIR = BASE_DIR / "results_SAGE_FIX"
...
- Make it readable and useful"""
    ...
    synthesis = client.messages.create(
        model=TEST_MODEL,
        max_tokens=4000,  # SAGE FIX: 4x more synthesis tokens
        system=BASE_SYSTEM,
    ...
    return synthesis.content[0].text, elapsed, {
        "condition": "C_EMERGENCE_FIXED",
        "estimated_tokens": 5400,  # SAGE FIX: 7*200 + 1*4000
...
def run_test():
    ...
    trials = trials[:30]  # SAGE FIX VALIDATION: Quick 30-trial test
